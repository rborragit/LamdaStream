...
public class CheckPassword {
	...
	public static void main(String args[]){
		...
		out.print("What's your password?");
		...
		if (password == "swordfish"){
			...
			out.println("The word you types is not");
			out.println("stored in the same place as the");
			out.println("real password, but that's");
			out.println("not a big deal");
		...
		if (password.equals("swordfish")){
			...
			out.println("password. You must use our");
			...
			out.println("use our precious sytem.");
